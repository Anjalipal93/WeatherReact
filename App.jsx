...
const App = () => {
  ...
  const API_KEY = "1efaa84dd5e1c306089b7a7972c77b69";
  ...
  return (
    <div className="min-h-screen mb-30 ml-10">
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              <input
                ...
                className="mb-4 p-3 rounded border border-white bg-transparent text-white placeholder-white focus:border-blue-300 transition duration-300"
              />
                ...
                <div className="absolute top-12 left-0 bg-transparent shadow-md rounded z-10">
                  {suggestion.map((s) => (
                    <button
                      ...
                      className="block <hover:bg-orange-3></hover:bg-orange-3>00 bg-transparent px-4 py-2 text-sm text-left w-full transition-colors"
                    >
                      {s.name},{s.country}
                      {s.state && `,${s.state}`}
                    </button>
              ...
              <button
                type="submit"
                className="color:yellow bg-grey-300 hover:bg-red-50 text-black font-bold py-2 px-4 rounded transition-colors "
              >
                Get Weather
              </button>
            </form>
          ) : (
            <div className="mt-6 text-center transition-opacity duration-500 color:red">
              <button
                onClick={() => {
                  setWeather(null);
                  setCity("");
                }}
              className=" bg-grey-200 border-2 border-grey-400 mb-4  hover:bg-grey-500 text-black font-semibold py-1 px-3 rounded transition-colors"
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className={`font-semibold py-1 px-3 rounded transition-colors ${
                    unit === "C"
                      ? "bg-grey-200 text-black hover:bg-grey-400"
                      : "bg-yellow-500 text-black hover:bg-blue-200"
                  }`}
                >
                  &deg;{unit}
                </button>
              ...
              />
              <p className="text-4xl bg-blue-10">
